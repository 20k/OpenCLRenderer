...
void allocate_gpu(std::vector<obj_g_descriptor> &object_descriptors, int mipmap_start, cl_uint trianglecount)
{
    ...
    t.g_texture_array = compute::image3d(cl::context, CL_MEM_READ_WRITE, imgformat, 2048, 2048, number_of_texture_slices, 0, 0, NULL);
    ...
    //cl_mem m = clCreateImage3D(cl::context.get(), CL_MEM_READ_WRITE, &form, 2048, 2048, number_of_texture_slices, 0, 0, NULL, &er);
