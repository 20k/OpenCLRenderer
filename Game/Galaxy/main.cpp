...
vector<star> construct_starmap(int** vals)
{
    vector<star> svec;
...
vector<star> get_starmap(int rand_val)
{
    srand(rand_val);

    int** vals = standard_scatter();
    vector<star> stars = construct_starmap(vals);
...
//void transf(cl_float4 pos, cl_float4 )

cl_float4 rot_a(cl_float4 point, cl_float4 c_pos, cl_float4 c_rot)
{
    cl_float4 cos_rot;
